...
#Extra summary to see Triple Oak PM2.5 values
EPAair.SummaryB_wNAs <- 
EPAair.B.F.Spread %>% 
  group_by(Site.Name) %>% 
  summarise (mean_Ozone = mean(Ozone), 
            min_Ozone = min(Ozone), 
...
#See SummaryB above. 
#Added second summary to see PM Triple Oak PM values that were filtered out w/ NA filter. 
print(EPAair.SummaryB_wNAs)
