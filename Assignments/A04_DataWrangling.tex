...
\NormalTok{EPAair_O3_}\DecValTok{17}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2017_raw.csv"}\NormalTok{)}
\NormalTok{EPAair_O3_}\DecValTok{18}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPAair_PM25_}\DecValTok{17}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2017_raw.csv"}\NormalTok{)}
\NormalTok{EPAair_PM25_}\DecValTok{18}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{)}

\CommentTok{#2}
\CommentTok{#Summary of O3_17}
\KeywordTok{dim}\NormalTok{(EPAair_O3_}\DecValTok{17}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPAair_O3_}\DecValTok{17}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(EPAair_O3_}\DecValTok{17}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#3}
\NormalTok{EPAair_O3_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair_O3_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair_O3_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair_O3_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair_O3_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =}\StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair_O3_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair_PM25_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair_PM25_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =}\StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair_PM25_}\DecValTok{17}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair_PM25_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair_PM25_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =}\StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair_PM25_}\DecValTok{18}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#4}
\NormalTok{EPAair_O3_}\FloatTok{17.}\NormalTok{select <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair_O3_}\DecValTok{17}\NormalTok{, Date,DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\NormalTok{EPAair_O3_}\FloatTok{18.}\NormalTok{select <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair_O3_}\DecValTok{18}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\NormalTok{EPAair_PM25_}\FloatTok{17.}\NormalTok{select <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair_PM25_}\DecValTok{17}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\NormalTok{EPAair_PM25_}\FloatTok{18.}\NormalTok{select <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair_PM25_}\DecValTok{18}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\CommentTok{#5}
\NormalTok{EPAair_PM25_}\FloatTok{17.}\NormalTok{select}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ "PM2.5"}  

\NormalTok{EPAair_PM25_}\FloatTok{18.}\NormalTok{select}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ "PM2.5"} 

\CommentTok{#6}
\KeywordTok{write.csv}\NormalTok{(EPAair_O3_}\FloatTok{17.}\NormalTok{select, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_O3_17.select_Processed.csv"}\NormalTok{)}

\KeywordTok{write.csv}\NormalTok{(EPAair_O3_}\FloatTok{18.}\NormalTok{select, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_O3_18.select_Processed.csv"}\NormalTok{)}

\KeywordTok{write.csv}\NormalTok{(EPAair_PM25_}\FloatTok{17.}\NormalTok{select, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_PM25_17.select_Processed.csv"}\NormalTok{)}

\KeywordTok{write.csv}\NormalTok{(EPAair_PM25_}\FloatTok{18.}\NormalTok{select, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_PM25_18.select_Processed.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#7}
\NormalTok{EPAairBind <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(EPAair_O3_}\FloatTok{17.}\NormalTok{select,EPAair_O3_}\FloatTok{18.}\NormalTok{select,EPAair_PM25_}\FloatTok{17.}\NormalTok{select,EPAair_PM25_}\FloatTok{18.}\NormalTok{select)}

\CommentTok{#8}
\NormalTok{EPAairBind.Filter <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAairBind }\OperatorTok{%>%}\StringTok{ }
...
\CommentTok{#9}
\NormalTok{EPAair.B.F.Spread <-}\StringTok{ }\KeywordTok{spread}\NormalTok{(EPAairBind.Filter, AQS_PARAMETER_DESC, DAILY_AQI_VALUE)}

\CommentTok{#10}
\KeywordTok{dim}\NormalTok{(EPAair.B.F.Spread)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#11}
\KeywordTok{write.csv}\NormalTok{(EPAair.B.F.Spread, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#12a}
\NormalTok{ EPAair.SummaryA <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.B.F.Spread }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Month) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarise}\NormalTok{ (}\DataTypeTok{mean_Ozone =} \KeywordTok{mean}\NormalTok{(Ozone, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{min_Ozone =} \KeywordTok{min}\NormalTok{(Ozone, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{max_Ozone =} \KeywordTok{max}\NormalTok{(Ozone, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{),}
            \DataTypeTok{mean_PM2.5 =} \KeywordTok{mean}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{),}
            \DataTypeTok{min_PM2.5 =} \KeywordTok{min}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{),}
            \DataTypeTok{max_PM2.5 =} \KeywordTok{max}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{))}

\CommentTok{#12b}
\NormalTok{EPAair.SummaryB <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.B.F.Spread }\OperatorTok{%>%}\StringTok{ }
...
\begin{verbatim}
## # A tibble: 12 x 7
##    Month mean_Ozone min_Ozone max_Ozone mean_PM2.5 min_PM2.5 max_PM2.5
##    <dbl>      <dbl>     <dbl>     <dbl>      <dbl>     <dbl>     <dbl>
##  1     1       31.5         8        46       34.6         3        78
##  2     2       35.5        20        54       36.7         4        83
##  3     3       42.4        31        67       35.1         7        83
##  4     4       44.3        22        71       32.5         0        68
##  5     5       38.9        13        71       31.7         0        62
##  6     6       38.7        11        71       33.3         5        59
##  7     7       38.2         5        77       33.1         8        58
##  8     8       34.0        17        50       33.7         7        59
##  9     9       32.6        12        97       31.9         8        58
## 10    10       32.1        14        49       29.3         3        61
## 11    11       30.1         5        47       36.8         5        64
## 12    12       29.8        19        40       41.1         7        70
\end{verbatim}
